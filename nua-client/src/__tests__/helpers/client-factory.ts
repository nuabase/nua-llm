...
export function createTestClient(mode: TestMode): Nua {
  ...
  const providerConfigs: Array<{
    ...
    { provider: 'groq', envKey: 'GROQ_API_KEY', defaultModel: 'llama-3.1-8b-instant' },
    { provider: 'openrouter', envKey: 'OPENROUTER_API_KEY', defaultModel: 'openai/gpt-4o-mini' },
    { provider: 'cerebras', envKey: 'CEREBRAS_API_KEY', defaultModel: 'llama3.1-8b' },
    { provider: 'gemini', envKey: 'GEMINI_API_KEY', defaultModel: 'gemini-1.5-flash' },
  ];
